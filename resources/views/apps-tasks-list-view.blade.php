                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="mary-gant">
                                                <span class="flex-shrink-0">
                                                    <img src="{{URL::asset('assets/images/users/avatar-4.jpg')}}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="diego-norris">
                                                <span class="flex-shrink-0">
                                                    <img src="{{URL::asset('assets/images/users/avatar-9.jpg')}}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
