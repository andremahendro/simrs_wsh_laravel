            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        case ('ru'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/russia.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('it'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/italy.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('sp'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/spain.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('ch'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/china.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('fr'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/french.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('gr'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/germany.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('ae'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/ae.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php case ('id'): ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/id.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                        <?php break; ?>
                        <?php default: ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="<?php echo e(url('index/id')); ?>" class="dropdown-item notify-item language" data-lang="sp" title="Spanish">
                            <img src="<?php echo e(URL::asset('assets/images/flags/id.svg')); ?>" alt="user-image" class="me-2 rounded" height="20">
...
<?php /**PATH C:\laragon\www\simrs_wsh_laravel\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>